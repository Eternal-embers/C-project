...
#include<time.h>
#define line printf("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n")
#define song_info "D:\\C-project\\歌曲信息管理系统\\song_info.txt"
#define help_file "D:\\C-project\\歌曲信息管理系统\\help.txt"
#define orgin_c "D:\\C-project\\歌曲信息管理系统\\歌曲信息管理系统C源文件.txt"
#define backup "D:\\C-project\\歌曲信息管理系统\\song_backup.txt"
#define LEN1 40
#define LEN2 30
struct song{
	char name[LEN1];//歌曲名称
...
const char *_date = "专辑";
//菜单选项，用于与所输入的选项映射
const char order[15][10]={"end","input","print","change","delete","search",
